...
export function calculateTargetTimeline(
 ...
 messageAr = ` العجز الحالي (${Math.abs(dailyDeficitSurplusKcal)} ك.س) قد يؤدي لفقدان كتل عضلية! المعدل الآمن لجسمك هو ${minSafeWeeklyLoss} إلى ${maxSafeWeeklyLoss} كجم/أسبوع.`;
 } else {
