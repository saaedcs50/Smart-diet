...
export const MedicalConditionsEditor: React.FC<MedicalConditionsEditorProps> = ({
  ...
  const handleToggleShowToClient = () => {
    ...
    onNotify(nextVal ? 'سيظهر ملخص الحالات للعميل في ملفه الصحي 👁️' : 'تم إخفاء بطاقة الحالات عن العميل 🔒');
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="p-4 rounded-2xl bg-gradient-to-r from-teal-500/10 via-emerald-500/10 to-blue-500/10 border border-teal-200 dark:border-teal-900/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 rounded-full text-[11px] font-black bg-teal-100 dark:bg-teal-950 text-teal-800 dark:text-teal-300 border border-teal-300 dark:border-teal-700">
      ...
      <div className="p-3.5 rounded-2xl bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-2xs">
        <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2 rounded-xl text-xs font-black bg-emerald-600 hover:bg-emerald-700 disabled:opacity-40 text-white transition-all flex items-center justify-center gap-1.5 shadow-xs active:scale-95 cursor-pointer"
        >
            ...
            >
              ...
              {isActive && (
                <div className="px-3.5 pb-3.5 pt-1 border-t border-emerald-200/60 dark:border-emerald-900/40 space-y-2.5 animate-in slide-in-from-top duration-150">
                  ...
                  <div className="p-2.5 rounded-xl bg-white/80 dark:bg-slate-900/60 border border-emerald-200/60 dark:border-emerald-800/40 text-[11px] text-emerald-900 dark:text-emerald-200 flex items-start gap-1.5">
                      ...
                      <div className="grid grid-cols-3 gap-1">
                        {[
                          ...
                          <button
                            ...
                            className={`py-1 px-1 rounded-lg text-[10px] font-bold border transition-colors cursor-pointer ${
      ...
      {showMacroSuggestionModal && suggestedResult && (
        <div className="fixed inset-0 z-60 bg-slate-900/75 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 animate-in zoom-in-95 duration-150">
          <div className="bg-white dark:bg-slate-900 w-full max-w-xl rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl max-h-[90vh] flex flex-col overflow-hidden">
            {/* Modal Header */}
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4 text-xs">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  ...
                  <div className="p-3 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-300 dark:border-emerald-700 space-y-2">
                    <span className="text-[11px] font-black text-emerald-800 dark:text-emerald-300 block text-center">
              ...
              {/* Medical Disclaimer */}
              <div className="p-2.5 rounded-xl bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 text-[10px] text-amber-900 dark:text-amber-200 leading-relaxed">
                ⚖️ <strong>تنويه سريري:</strong> هذه الاقتراحات إرشادية عامة مبنية على المراجع التغذوية المعتمدة، ولا تلغي التقييم الفردي من قِبل الأخصائي وفق نتائج الفحوصات الدورية للمتدرب.
              </div>
            </div>
