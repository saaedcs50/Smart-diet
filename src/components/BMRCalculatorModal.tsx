...
export const BMRCalculatorModal: React.FC<BMRCalculatorModalProps> = ({
  ...
  return (
    <div 
      ...
      dir="rtl"
    >
      <div className="bg-white dark:bg-slate-900 w-full max-w-xl rounded-3xl p-4 sm:p-6 border border-slate-200 dark:border-slate-800 shadow-2xl my-auto max-h-[95vh] flex flex-col">
        
        {/* Header */}
        <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800 shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-emerald-600 via-teal-600 to-blue-600 text-white flex items-center justify-center font-black shadow-md shadow-emerald-500/20">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black bg-emerald-100 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 px-2 py-0.5 rounded-md border border-emerald-200 dark:border-emerald-800">
                  لوحة الأخصائية
                </span>
              </div>
          ...
          <div className="p-1 rounded-2xl bg-slate-100 dark:bg-slate-800/80 grid grid-cols-2 gap-1 border border-slate-200/80 dark:border-slate-700/60">
            <button
              ...
              className={`py-2.5 px-3 rounded-xl text-xs sm:text-sm font-black transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
                activeMethod === 'samar'
                  ? 'bg-white dark:bg-slate-900 text-emerald-600 dark:text-emerald-400 shadow-sm shadow-slate-200 dark:shadow-none scale-[1.01]'
                  : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200'
              }`}
            >
              <Sparkles className="w-4 h-4 text-emerald-500" />
              <span>معادلة سمر</span>
              <span className="text-[10px] font-black bg-emerald-100 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-300 px-1.5 py-0.2 rounded-md">
                الوزن المثالي
              </span>
            </button>
            ...
            <button
              ...
              className={`py-2.5 px-3 rounded-xl text-xs sm:text-sm font-black transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
                activeMethod === 'kholoud'
                  ? 'bg-white dark:bg-slate-900 text-blue-600 dark:text-blue-400 shadow-sm shadow-slate-200 dark:shadow-none scale-[1.01]'
                  : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200'
              }`}
            >
              <Flame className="w-4 h-4 text-blue-500" />
              <span>معادلة خلود</span>
              <span className="text-[10px] font-black bg-blue-100 dark:bg-blue-900/60 text-blue-700 dark:text-blue-300 px-1.5 py-0.2 rounded-md">
                REE الحرق
              </span>
            </button>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-2.5 rounded-2xl bg-emerald-50/70 dark:bg-emerald-950/40 border border-emerald-200/80 dark:border-emerald-900/50 text-xs">
                ...
                <div className="flex flex-wrap gap-1.5">
                  <button
                    ...
                    className="text-[11px] font-black text-emerald-800 dark:text-emerald-200 bg-white dark:bg-slate-850 px-2.5 py-1 rounded-lg border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 transition-colors shadow-2xs cursor-pointer active:scale-95"
                  >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  ...
                  >
                    ...
                    <span className="text-[10px] opacity-80 block mt-0.5">السعرات الكلية</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[10px] opacity-80 block mt-0.5">عجز −500 سعرة</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[10px] opacity-80 block mt-0.5">عجز −1000 سعرة</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[10px] opacity-80 block mt-0.5">فائض +300 سعرة</span>
                  </button>
                </div>
              </div>
              ...
              {samarCalc.isValid && (
                <div className="space-y-3">
                  ...
                  <div className="p-4 rounded-3xl bg-gradient-to-br from-emerald-500/15 via-teal-500/10 to-blue-500/10 border-2 border-emerald-400 dark:border-emerald-600 shadow-md">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div>
                        ...
                        <div className="flex items-baseline gap-2 mt-1">
                          <span className="text-3xl sm:text-4xl font-black text-emerald-950 dark:text-emerald-100 font-mono tracking-tight">
                            {samarGoalResult.targetCalories}
                          </span>
                  ...
                  <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-700 space-y-2 text-xs">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-slate-700 dark:text-slate-300">
                      ...
                      <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                        <span className="font-bold text-slate-500 block text-[10px]">1) الوزن المثالي:</span>
                      ...
                      {/* Step 2 */}
                      <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                        <span className="font-bold text-slate-500 block text-[10px]">2) الطاقة الأساسية:</span>
                        <div className="font-mono font-black text-slate-800 dark:text-slate-100 text-xs mt-0.5">
                      ...
                      {/* Step 3 */}
                      <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                        <span className="font-bold text-slate-500 block text-[10px]">3) طاقة النشاط ({samarWorkLevel === 'light' ? 'بسيط: 7' : samarWorkLevel === 'moderate' ? 'متوسط: 11' : 'شاق: 22'}):</span>
                        <div className="font-mono font-black text-slate-800 dark:text-slate-100 text-xs mt-0.5">
                      ...
                      {/* Step 4 */}
                      <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                        <span className="font-bold text-slate-500 block text-[10px]">4) السعرات الكلية:</span>
                        <div className="font-mono font-black text-slate-800 dark:text-slate-100 text-xs mt-0.5">
                    ...
                    <div className="pt-1.5 border-t border-slate-200 dark:border-slate-700/60 text-center">
                      <code className="text-[11px] font-mono font-bold text-emerald-800 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/60 px-2 py-1 rounded-lg border border-emerald-200 dark:border-emerald-800/60 inline-block">
                  ...
                  <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-700">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center">
                      {/* Protein */}
                      <div className="p-2.5 rounded-2xl bg-white dark:bg-slate-900 border border-blue-200 dark:border-blue-900/70 shadow-2xs">
                      ...
                      {/* Carbs */}
                      <div className="p-2.5 rounded-2xl bg-white dark:bg-slate-900 border border-emerald-200 dark:border-emerald-900/70 shadow-2xs">
                      ...
                      {/* Fats */}
                      <div className="p-2.5 rounded-2xl bg-white dark:bg-slate-900 border border-amber-200 dark:border-amber-900/70 shadow-2xs">
                  ...
                  <div className="p-2.5 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-200/80 dark:border-emerald-900/50 text-[11px] text-emerald-900 dark:text-emerald-200 flex items-start gap-1.5">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-2.5 rounded-2xl bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-200/80 dark:border-indigo-900/50 text-xs">
                ...
                <button
                  ...
                  className="text-[11px] font-black text-indigo-700 dark:text-indigo-300 bg-white dark:bg-slate-850 px-2.5 py-1 rounded-lg border border-indigo-200 dark:border-indigo-800 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 transition-colors shadow-2xs cursor-pointer active:scale-95"
                >
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <button
                    ...
                    className={`py-3 px-3 rounded-2xl text-xs font-black transition-all flex flex-col items-center justify-center gap-1 border cursor-pointer ${
                      gender === 'female'
                        ? 'bg-pink-600 border-pink-600 text-white shadow-md shadow-pink-500/20 scale-[1.01]'
                  ...
                  >
                    ...
                    <span className={`text-[11px] font-bold ${gender === 'female' ? 'text-pink-100' : 'text-slate-500 dark:text-slate-400'}`}>
                  ...
                  >
                    ...
                    <span className={`text-[11px] font-bold ${gender === 'male' ? 'text-blue-100' : 'text-slate-500 dark:text-slate-400'}`}>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div className="p-3 rounded-2xl bg-blue-50/80 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/60">
                  <div className="flex items-center justify-between text-xs text-blue-950 dark:text-blue-200">
                    ...
                    <span className="text-[10px] bg-blue-200/60 dark:bg-blue-900 text-blue-800 dark:text-blue-300 px-1.5 py-0.5 rounded-sm font-mono">
                      صيغة موحدة
                    </span>
                  </div>
                  <div className="mt-1 flex items-baseline gap-1">
                    ...
                    <span className="text-[11px] font-bold text-slate-500">ك.س/يوم</span>
                  </div>
                ...
                <div className="p-3 rounded-2xl bg-indigo-50/80 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-900/60">
                  <div className="flex items-center justify-between text-xs text-indigo-950 dark:text-indigo-200">
                    ...
                    <span className="text-[10px] bg-indigo-200/60 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-300 px-1.5 py-0.5 rounded-sm font-mono">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  ...
                  >
                    <span className="block text-xs font-black">تثبيت الوزن</span>
                    <span className="text-[10px] opacity-80 block mt-0.5">بدون عجز (TDEE)</span>
                  </button>
              ...
              {/* Kholoud Results Box */}
              <div className="p-4 rounded-3xl bg-gradient-to-br from-blue-500/15 via-indigo-500/10 to-purple-500/10 border-2 border-blue-400 dark:border-blue-600 shadow-md">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    ...
                    <div className="flex items-baseline gap-2 mt-1">
                      <span className="text-3xl sm:text-4xl font-black text-blue-950 dark:text-blue-100 font-mono tracking-tight">
                        {kholoudGoalResult.targetCalories}
                      </span>
              ...
              <div className="p-2.5 rounded-2xl bg-slate-100/80 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-[11px] text-slate-600 dark:text-slate-300 flex items-start gap-1.5">
        ...
        <div className="pt-3.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2 shrink-0">
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-2xl font-black text-xs sm:text-sm transition-all flex items-center gap-2 shadow-md cursor-pointer active:scale-95 ${
