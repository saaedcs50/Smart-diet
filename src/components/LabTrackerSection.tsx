    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-5 shadow-xs transition-colors space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-teal-500 text-white flex items-center justify-center font-bold text-sm shadow-xs shadow-teal-500/20">
            🧪
          </div>
          <div>
        ...
        {labConfig.allowClientAdd && (
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-teal-50 hover:bg-teal-100 dark:bg-teal-950/60 dark:hover:bg-teal-900/60 text-teal-700 dark:text-teal-300 border border-teal-200 dark:border-teal-800 text-xs font-bold transition-all shadow-2xs"
          >
          ...
          {testKeys.map((key) => {
            ...
            return (
              <button
                ...
                className="text-right p-3.5 rounded-2xl bg-slate-50 hover:bg-slate-100/80 dark:bg-slate-800/50 dark:hover:bg-slate-800 border border-slate-200/70 dark:border-slate-700/60 transition-all hover:shadow-xs group flex flex-col justify-between gap-2.5"
              >
                ...
                <div className="flex items-center justify-between w-full pt-1 border-t border-slate-200/50 dark:border-slate-700/40">
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border truncate max-w-[200px] ${evalResult.badgeClass}`}>
                    {evalResult.label}
                  </span>
                  <span className="text-[10px] text-teal-600 dark:text-teal-400 font-bold group-hover:translate-x-[-2px] transition-transform">
                    عرض الرسم ←
                  </span>
                </div>
              </button>
      ...
      {selectedTestKey && selectedSummary && selectedMeta && (
        ...
        >
          <div
            className="w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl p-5 sm:p-6 border border-slate-200 dark:border-slate-800 shadow-2xl space-y-5 animate-in zoom-in-95 duration-150 my-auto"
          ...
          >
            ...
            {/* Latest Value Banner */}
            <div className="p-4 rounded-2xl bg-gradient-to-r from-teal-500/10 via-cyan-500/10 to-blue-500/10 dark:from-teal-950/40 dark:via-cyan-950/40 dark:to-blue-950/40 border border-teal-200/70 dark:border-teal-900/50 flex items-center justify-between">
              <div>
            ...
            <div className="p-3.5 rounded-2xl bg-teal-50/50 dark:bg-teal-950/20 border border-teal-200/60 dark:border-teal-900/40 text-xs text-teal-900 dark:text-teal-200 space-y-1">
              ...
              <p className="leading-relaxed text-[11px] text-teal-800 dark:text-teal-300">
            ...
            <div className="flex items-center justify-between pt-2">
              {labConfig.allowClientAdd ? (
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-teal-600 hover:bg-teal-700 active:scale-95 text-white font-bold text-xs shadow-2xs transition-all flex items-center gap-1.5"
                >
                  <Plus className="w-3.5 h-3.5" />
      ...
      {showAddModal && (
        ...
        >
          <form
            ...
            className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl p-5 sm:p-6 border border-slate-200 dark:border-slate-800 shadow-2xl space-y-4 animate-in zoom-in-95 duration-150 my-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                type="submit"
                className="px-5 py-2 rounded-xl bg-teal-600 hover:bg-teal-700 active:scale-95 text-white text-xs font-bold shadow-xs transition-all"
              >
                حفظ النتيجة 🧪
              </button>
            </div>
      ...
      <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/60 dark:border-slate-800 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed flex items-start gap-2">
