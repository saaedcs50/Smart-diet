...
// ============================================================================
// ملاحظة أمان: قبل كده كان فيه قيمة افتراضية ثابتة مكتوبة في الكود
// ('smart-diet-coach-secret-key-2026') بتتكرر في كل نسخة تتباع للعملاء.
// ده كان بيسمح لأي حد يقرأ الكود إنه يزوّر جلسة طبيبة صالحة لأي عميل.
// دلوقتي: لازم يتحدد SESSION_SECRET في متغيرات البيئة، وإلا التطبيق
// هيرفض يشتغل في بيئة الإنتاج.
...
// ============================================================================
// PIN من 5 أرقام قابل للتخمين بسهولة بمحاولات كتيرة متتالية بدون أي حد أقصى.
// الحل ده بسيط (في الذاكرة، لكل عملية سيرفر) لمنع محاولات القوة الغاشمة.
...
// فحص إعدادات الأمان عند بدء التشغيل: بيوقف السيرفر فورًا في بيئة الإنتاج
// لو SESSION_SECRET أو COACH_PIN مش متحددين، بدل ما يكتشف المشكلة أول عميل يدخل.
